...
```
opkg install https://bin.entware.net/aarch64-k3.10/archive/node_v16.19.1-1_aarch64-3.10.ipk https://bin.entware.net/aarch64-k3.10/archive/node-npm_v16.19.1-1_aarch64-3.10.ipk git-http daemonize
```
